...
def get_datai(ticker,start=None,end=None,src="yahoo",days=1090,debugTF=False):
...
def run_macd(df,pcol='close',nFast=12,nSlow=26,nSig=9,nRsi=14,lh=[30,70],debugTF=False):
	...
	##---TBD
	#colx= ["rsi","ema_slow","ema_fast","macd_ema","macd_cnt","macd_cnt_cross"]
	#coly= [rsi,emaSlow,emaFast,macdEma,macdCnt,macdCntCross]
